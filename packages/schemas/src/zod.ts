...
export const simulationInputSchema = z.object({
  ...
  zoneMedianPricePerSqm: z.number().min(0).optional(),
  zoneMinPricePerSqm: z.number().min(0).optional(),
  zoneMaxPricePerSqm: z.number().min(0).optional(),
  zonePriceSource: z.string().optional(),
  zoneRentMedianPerSqm: z.number().min(0).optional(),
  zoneRentMinPerSqm: z.number().min(0).optional(),
  zoneRentMaxPerSqm: z.number().min(0).optional(),
  zoneRentSource: z.string().optional(),
