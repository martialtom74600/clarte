...
## Limitations du moteur de calcul (pack 2026.5)
...
- Rachat (`keep_*`) : soulte + **indemnité d'occupation** indicative (loyer estimé ÷ 2 × mois d'occupation exclusive) ; feu croisé financement racheteur **et** relogement du partant dans la zone
